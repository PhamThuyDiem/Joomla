...
public class ARTICLE_TC016_VerifyUserCanChangeTheFeaturePropertyOfArticlesUsingTheFeaturedColumn extends Configure{
	...
	public void login(String url, String user, String password, String title, String category, String status,
		...
		Log.info("-----------TC_JOOMLA_ARTICLE_016-------------");
		...
		articlesPageAction.clickIconUnfeatured(title);

		Log.info("Step 15: Verify the article is featured successfully");
		verifyTrue(articlesPageAction.checkFeaturedSuccessfully(title));
		...
		articlesPageAction.clickIconFeatured(title);

		Log.info("Step 18: Verify the article is unfeatured successfully");
		verifyTrue(articlesPageAction.checkUnfeaturedSuccessfully(title));

		Reporter.log("Verify user can change the feature property of articles using the Featured column");
	}
	...
	public Object[][] credentials() throws Exception {
		return new Object[][] { new Object[] { Constant.TC_JOOMLA_ARTICLE_016.getUrl,
				Constant.TC_JOOMLA_ARTICLE_016.txtUser, Constant.TC_JOOMLA_ARTICLE_016.txtPassword,
				Constant.TC_JOOMLA_ARTICLE_016.txtTitle, Constant.TC_JOOMLA_ARTICLE_016.cbbCategory,
				Constant.TC_JOOMLA_ARTICLE_016.cbbStatus, Constant.TC_JOOMLA_ARTICLE_016.textContent }, };
	}
}
