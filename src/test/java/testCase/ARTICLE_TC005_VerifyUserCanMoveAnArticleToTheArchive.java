...
public class ARTICLE_TC005_VerifyUserCanMoveAnArticleToTheArchive extends Configure {
	...
	public void login(String url, String user, String password, String title, String category, String content) {
		...
		Log.info("-----------TC_JOOMLA_ARTICLE_005-------------");
		...
		articlesPageAction.clickArchive();

		Log.info("Step 14: Verify the confirm message is displayed");
		articlesPageAction.checkArchivedSuccessfully(title);
		
		Log.info("Step 15: Select 'Archived' item of 'Status' dropdown list");
		articlesPageAction.clickSearchTools("Archived");

		Log.info("Step 16: Verify the archived article is displayed on the table grid");
		articlesPageAction.checkArchivedArticle(title);
		
		Reporter.log("Verify user can move an article to the archive");
	}
	...
	public Object[][] credentials() throws Exception {
		return new Object[][] {
				new Object[] { Constant.TC_JOOMLA_ARTICLE_005.getUrl, Constant.TC_JOOMLA_ARTICLE_005.txtUser,
						Constant.TC_JOOMLA_ARTICLE_005.txtPassword, Constant.TC_JOOMLA_ARTICLE_005.txtTitle,
						Constant.TC_JOOMLA_ARTICLE_005.cbbCategory, Constant.TC_JOOMLA_ARTICLE_005.textContent }, };
	}
