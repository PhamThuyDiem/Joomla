...
public class BANNERS_TC002_VerifyThatUserCanEditABanner extends Configure{
	...
	public void login(String url, String user, String password, String clientName ,String contactName, String contactEmail, 
			String title, String bannerName, String category, String bannerNameEdited) {

		Log.info("-----------TC_JOOMLA_BANNERS_002-------------");
		...
		verifyTrue(newBannersPageAction.checkBannerSuccessfully());
		
		Log.info("Step 23: Enter valid Banner name to Name textbox");
		newBannersPageAction.inputName(bannerNameEdited);
		
		Log.info("Step 24: Click Save & Close button");
		newBannersPageAction.clickSaveClose();
		
		Log.info("Step 25: Verify that user can edit a banner");
		verifyTrue(bannersPageAction.checkBannerSuccessfullySaved(bannerNameEdited));
		
		Reporter.log("Verify that user can edit a banner");
	}
	...
	public Object[][] credentials() throws Exception {
		return new Object[][] { new Object[] { Constant.TC_JOOMLA_BANNERS_BANNERS_002.getUrl,
				Constant.TC_JOOMLA_BANNERS_BANNERS_002.txtUser, Constant.TC_JOOMLA_BANNERS_BANNERS_002.txtPassword,
				Constant.TC_JOOMLA_BANNERS_BANNERS_002.txtClientName, Constant.TC_JOOMLA_BANNERS_BANNERS_002.txtContactName,
				Constant.TC_JOOMLA_BANNERS_BANNERS_002.txtContactEmail, Constant.TC_JOOMLA_BANNERS_BANNERS_002.txtTitle,
				Constant.TC_JOOMLA_BANNERS_BANNERS_002.txtName, Constant.TC_JOOMLA_BANNERS_BANNERS_002.cbbCategory,
				Constant.TC_JOOMLA_BANNERS_BANNERS_002.txtBannerEdited}, };
	}
}
