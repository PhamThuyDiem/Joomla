...
public class BANNERS_TC003_VerifyThatUserCanCreateANewBannerWithUnpublishedStatus extends Configure {
	...
	public void login(String url, String user, String password, String clientName, String contactName,
			String contactEmail, String title, String bannerName, String category, String status) {

		Log.info("-----------TC_JOOMLA_BANNERS_BANNERS_002-------------");
		...
		newBannersPageAction.selectStatus(status);

		Log.info("Step 22: Click Save & Close button");
		newBannersPageAction.clickSaveClose();

		Log.info("Step 23: A message : Banner successfully saved shows and new banner is created");
		verifyTrue(bannersPageAction.checkBannerSuccessfullySave(bannerName, category, clientName));

		Reporter.log("Verify that user can create a new banner with unpublished status");
	}
	...
	public Object[][] credentials() throws Exception {
		return new Object[][] { new Object[] { Constant.TC_JOOMLA_BANNERS_BANNERS_003.getUrl,
				Constant.TC_JOOMLA_BANNERS_BANNERS_003.txtUser, Constant.TC_JOOMLA_BANNERS_BANNERS_003.txtPassword,
				Constant.TC_JOOMLA_BANNERS_BANNERS_003.txtClientName,
				Constant.TC_JOOMLA_BANNERS_BANNERS_003.txtContactName,
				Constant.TC_JOOMLA_BANNERS_BANNERS_003.txtContactEmail, Constant.TC_JOOMLA_BANNERS_BANNERS_003.txtTitle,
				Constant.TC_JOOMLA_BANNERS_BANNERS_003.txtName, Constant.TC_JOOMLA_BANNERS_BANNERS_003.cbbCategory,
				Constant.TC_JOOMLA_BANNERS_BANNERS_003.cbbStatus }, };
	}
}
