...
public class BANNERS_TC012_VerifyThatUserCanBrowseNewBannerHelpPageInNewBannerPage extends Configure{
	...
	public void login(String url, String user, String password) {
		...
		Log.info("Step 5: Click New button in the top right corner");
		bannersPageAction.clickNew();
		
		Log.info("Step 6: Click Help button in the right top corner");
		newBannersPageAction.clickHelp();

		Log.info("Step 7: Banner help page appears");
