...
public class BANNERS_TC009_VerifyThatUserCanSearchABannerByUsingFilterDropdownLists extends Configure{
	...
	public void login(String url, String user, String password, String clientName ,String contactName, String contactEmail, 
		...
		Log.info("-----------TC_JOOMLA_BANNERS_008-------------");
		...
		bannersPageAction.selectClient(clientName);
		
		Log.info("Step 24: Select Category that banner belong to in Category dropdown list");
		bannersPageAction.selectCategory(category);
		
		Log.info("Step 25: Verify: Recently created banner displays");
		verifyTrue(bannersPageAction.checkCreatedBannerDisplays(bannerName));
		
		Reporter.log("Verify that user can search a banner by using filter dropdown lists");
	}
	...
	public Object[][] credentials() throws Exception {
		return new Object[][] { new Object[] { Constant.TC_JOOMLA_BANNERS_BANNERS_009.getUrl,
				Constant.TC_JOOMLA_BANNERS_BANNERS_009.txtUser, Constant.TC_JOOMLA_BANNERS_BANNERS_009.txtPassword,
				Constant.TC_JOOMLA_BANNERS_BANNERS_009.txtClientName, Constant.TC_JOOMLA_BANNERS_BANNERS_009.txtContactName,
				Constant.TC_JOOMLA_BANNERS_BANNERS_009.txtContactEmail, Constant.TC_JOOMLA_BANNERS_BANNERS_009.txtTitle,
				Constant.TC_JOOMLA_BANNERS_BANNERS_009.txtName, Constant.TC_JOOMLA_BANNERS_BANNERS_009.cbbCategory}, };
	}
