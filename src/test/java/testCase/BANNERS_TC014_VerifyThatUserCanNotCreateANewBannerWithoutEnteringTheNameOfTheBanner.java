...
public class BANNERS_TC014_VerifyThatUserCanNotCreateANewBannerWithoutEnteringTheNameOfTheBanner extends Configure{
	...
	public void login(String url, String user, String password, String clientName ,String contactName, String contactEmail, 
		...
		Log.info("-----------TC_JOOMLA_BANNERS_014-------------");
		...
		Log.info("Step 21: The color of Name textbox changes to red and New banner is not created");
		verifyTrue(newBannersPageAction.checkColorOfNameTextboxChangesToRed());
		verifyTrue(bannersPageAction.checkBannerIsNotCreated(clientName, category));
		
		Reporter.log("Verify that user cannot create a new banner without entering the name of the banner");
	}
	...
	public Object[][] credentials() throws Exception {
		return new Object[][] { new Object[] { Constant.TC_JOOMLA_BANNERS_BANNERS_014.getUrl,
				Constant.TC_JOOMLA_BANNERS_BANNERS_014.txtUser, Constant.TC_JOOMLA_BANNERS_BANNERS_014.txtPassword,
				Constant.TC_JOOMLA_BANNERS_BANNERS_014.txtClientName, Constant.TC_JOOMLA_BANNERS_BANNERS_014.txtContactName,
				Constant.TC_JOOMLA_BANNERS_BANNERS_014.txtContactEmail, Constant.TC_JOOMLA_BANNERS_BANNERS_014.txtTitle,
				Constant.TC_JOOMLA_BANNERS_BANNERS_014.txtName, Constant.TC_JOOMLA_BANNERS_BANNERS_014.cbbCategory}, };
	}
