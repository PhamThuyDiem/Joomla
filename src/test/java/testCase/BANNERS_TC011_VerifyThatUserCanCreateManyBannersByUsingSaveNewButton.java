...
public class BANNERS_TC011_VerifyThatUserCanCreateManyBannersByUsingSaveNewButton extends Configure{
	...
	public void login(String url, String user, String password, String clientName ,String contactName, String contactEmail, 
			String title, String bannerName, String category, String bannerNameNew) {

		Log.info("-----------TC_JOOMLA_BANNERS_011-------------");
		...
		Log.info("Step 21: Click Save & New button");
		newBannersPageAction.clickSaveNew();
		
		Log.info("Step 22: A message : Banner successfully saved shows and New banner page displays");
		verifyTrue(newBannersPageAction.checkSuccessfullySavedShowsAndNewBannerPageDisplays());
		
		Log.info("Step 23: Enter valid Name to Name textbox");
		newBannersPageAction.inputName(bannerNameNew);
		...
		Log.info("Step 27: A message : Banner successfully saved shows and new banner is created");
		verifyTrue(bannersPageAction.checkTwoNewBannersAreCreatedAndMatchedEnteredData(bannerName, bannerNameNew, category, clientName));
		
		Reporter.log("Verify that user can create many banners by using Save & New button");
	}
	...
	public Object[][] credentials() throws Exception {
		return new Object[][] { new Object[] { Constant.TC_JOOMLA_BANNERS_BANNERS_011.getUrl,
				Constant.TC_JOOMLA_BANNERS_BANNERS_011.txtUser, Constant.TC_JOOMLA_BANNERS_BANNERS_011.txtPassword,
				Constant.TC_JOOMLA_BANNERS_BANNERS_011.txtClientName, Constant.TC_JOOMLA_BANNERS_BANNERS_011.txtContactName,
				Constant.TC_JOOMLA_BANNERS_BANNERS_011.txtContactEmail, Constant.TC_JOOMLA_BANNERS_BANNERS_011.txtTitle,
				Constant.TC_JOOMLA_BANNERS_BANNERS_011.txtName, Constant.TC_JOOMLA_BANNERS_BANNERS_011.cbbCategory,
				Constant.TC_JOOMLA_BANNERS_BANNERS_011.txtNameNew}, };
	}
