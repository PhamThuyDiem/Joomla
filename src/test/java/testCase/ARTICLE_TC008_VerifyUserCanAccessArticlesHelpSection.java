...
public class ARTICLE_TC008_VerifyUserCanAccessArticlesHelpSection extends Configure{
	...
	public void login(String url, String user, String password) {
		...
		Log.info("-----------TC_JOOMLA_ARTICLE_008-------------");
		...
		articlesPageAction.clickHelp();

		Log.info("Step 7: Verify the article's help window is displayed");
		verifyTrue(articlesPageAction.displayHelpWindow());
		
		Reporter.log("Verify user can access article's help section");
	}
	...
	public Object[][] credentials() throws Exception {
		return new Object[][] {
				new Object[] { Constant.TC_JOOMLA_ARTICLE_008.getUrl, Constant.TC_JOOMLA_ARTICLE_008.txtUser,
						Constant.TC_JOOMLA_ARTICLE_008.txtPassword}, };
	}
}
