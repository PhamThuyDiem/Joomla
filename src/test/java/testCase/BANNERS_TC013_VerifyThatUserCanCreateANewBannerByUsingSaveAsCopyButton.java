...
public class BANNERS_TC013_VerifyThatUserCanCreateANewBannerByUsingSaveAsCopyButton extends Configure{
	...
	public void login(String url, String user, String password, String clientName ,String contactName, String contactEmail, 
			String title, String bannerName, String category, String bannerNameEdit) {
		...
		Log.info("Step 22: A message : Banner successfully saved shows and Edit Banner page displays");
		verifyTrue(newBannersPageAction.checkBannerSuccessfullySavedAndEditBannerPageDisplays());
		
		Log.info("Step 23: Enter valid Banner name to Name textbox");
		newBannersPageAction.inputName(bannerNameEdit);
		
		Log.info("Step 24: Click Save as Copy button");
		newBannersPageAction.clickSaveAsCopy();
		
		Log.info("Step 22: A message : Banner successfully saved shows and New banner is created without replacing the old banner");
		verifyTrue(newBannersPageAction.checkBannerSuccessfullySaved());
		verifyTrue(bannersPageAction.checkNewBannerIsCreatedWithoutReplacingTheOldBanner(bannerName, bannerNameEdit));
		
		Reporter.log("Verify that user can create a new banner by using Save as Copy button");
	}
	...
	public Object[][] credentials() throws Exception {
		return new Object[][] { new Object[] { Constant.TC_JOOMLA_BANNERS_BANNERS_013.getUrl,
				Constant.TC_JOOMLA_BANNERS_BANNERS_013.txtUser, Constant.TC_JOOMLA_BANNERS_BANNERS_013.txtPassword,
				Constant.TC_JOOMLA_BANNERS_BANNERS_013.txtClientName, Constant.TC_JOOMLA_BANNERS_BANNERS_013.txtContactName,
				Constant.TC_JOOMLA_BANNERS_BANNERS_013.txtContactEmail, Constant.TC_JOOMLA_BANNERS_BANNERS_013.txtTitle,
				Constant.TC_JOOMLA_BANNERS_BANNERS_013.txtName, Constant.TC_JOOMLA_BANNERS_BANNERS_013.cbbCategory,
				Constant.TC_JOOMLA_BANNERS_BANNERS_013.bannerNameEdit}, };
	}
}
