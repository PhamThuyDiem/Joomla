...
public class BANNERS_TC004_VerifyThatUserCanUnpublishABanner extends Configure {
	...
	public void login(String url, String user, String password, String clientName ,String contactName, String contactEmail, 
		...
		Log.info("-----------TC_JOOMLA_BANNERS_004-------------");
		...
		bannersPageAction.clickUnpublish();
		
		Log.info("Step 25: A message : 1 banner successfully unpublished shows and banner is unpublished");
		verifyTrue(bannersPageAction.bannerSuccessfullyUnpublished(bannerName));
		
		Reporter.log("Verify that user can unpublish a banner");
	}
	...
	public Object[][] credentials() throws Exception {
		return new Object[][] { new Object[] { Constant.TC_JOOMLA_BANNERS_BANNERS_004.getUrl,
				Constant.TC_JOOMLA_BANNERS_BANNERS_004.txtUser, Constant.TC_JOOMLA_BANNERS_BANNERS_004.txtPassword,
				Constant.TC_JOOMLA_BANNERS_BANNERS_004.txtClientName, Constant.TC_JOOMLA_BANNERS_BANNERS_004.txtContactName,
				Constant.TC_JOOMLA_BANNERS_BANNERS_004.txtContactEmail, Constant.TC_JOOMLA_BANNERS_BANNERS_004.txtTitle,
				Constant.TC_JOOMLA_BANNERS_BANNERS_004.txtName, Constant.TC_JOOMLA_BANNERS_BANNERS_004.cbbCategory}, };
	}
}
