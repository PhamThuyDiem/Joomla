...
public class ARTICLE_TC015_VerifyUserCanChangeTheStatusOfArticlesUsingTheStatusColumn extends Configure {
	...
	public void login(String url, String user, String password, String title, String category, String status,
		...
		Log.info("-----------TC_JOOMLA_ARTICLE_015-------------");
		...
		articlesPageAction.clickIconPushlish(title);

		Log.info("Step 15: Verify the article is unpublished successfully");
		verifyTrue(articlesPageAction.checkUnpublishedSuccess(title));
		...
		articlesPageAction.clickIconUnpushlish(title);
		
		Log.info("Step 18: Verify the article is published successfully");
		verifyTrue(articlesPageAction.checkPublishedSuccess(title));
		
		Reporter.log("Verify user can change the status of articles using the Status column");
	}
	...
	public Object[][] credentials() throws Exception {
		return new Object[][] { new Object[] { Constant.TC_JOOMLA_ARTICLE_015.getUrl,
				Constant.TC_JOOMLA_ARTICLE_015.txtUser, Constant.TC_JOOMLA_ARTICLE_015.txtPassword,
				Constant.TC_JOOMLA_ARTICLE_015.txtTitle, Constant.TC_JOOMLA_ARTICLE_015.cbbCategory,
				Constant.TC_JOOMLA_ARTICLE_015.cbbStatus, Constant.TC_JOOMLA_ARTICLE_015.textContent }, };
	}
}
