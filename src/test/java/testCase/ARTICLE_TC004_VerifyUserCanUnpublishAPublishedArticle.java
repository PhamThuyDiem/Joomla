...
public class ARTICLE_TC004_VerifyUserCanUnpublishAPublishedArticle extends Configure {
	...
	public void login(String url, String user, String password, String title, String category, String status, String content) {
		...
		Log.info("-----------TC_JOOMLA_ARTICLE_004-------------");
		...
		articlesPageAction.clickUnpublish();

		Log.info("Step 15: Verify the article is unpublished successfully");
		articlesPageAction.checkUnpublishedSuccessfully(title);

		Reporter.log("Verify user can unpublish a published article");
	}
	...
	public Object[][] credentials() throws Exception {
		return new Object[][] {
				new Object[] { Constant.TC_JOOMLA_ARTICLE_004.getUrl, Constant.TC_JOOMLA_ARTICLE_004.txtUser,
						Constant.TC_JOOMLA_ARTICLE_004.txtPassword, Constant.TC_JOOMLA_ARTICLE_004.txtTitle,
						Constant.TC_JOOMLA_ARTICLE_004.cbbCategory, Constant.TC_JOOMLA_ARTICLE_004.cbbStatus, 
						Constant.TC_JOOMLA_ARTICLE_004.textContent }, };
	}
}
