...
public class BANNERS_TC008_VerifyThatUserCanSearchABannerByUsingFilterTextbox extends Configure{
	...
	public void login(String url, String user, String password, String clientName ,String contactName, String contactEmail, 
		...
		bannersPageAction.inputSearch(bannerName);
		
		Log.info("Step 24: Click Search button");
		bannersPageAction.clickSearch();
		
		Log.info("Step 25: Verify: Recently created banner displays");
		verifyTrue(bannersPageAction.displayText(bannerName));
		
		Reporter.log("Verify that user can search a banner by using filter textbox");
	}
	...
	public Object[][] credentials() throws Exception {
		return new Object[][] { new Object[] { Constant.TC_JOOMLA_BANNERS_BANNERS_008.getUrl,
				Constant.TC_JOOMLA_BANNERS_BANNERS_008.txtUser, Constant.TC_JOOMLA_BANNERS_BANNERS_009.txtPassword,
				Constant.TC_JOOMLA_BANNERS_BANNERS_008.txtClientName, Constant.TC_JOOMLA_BANNERS_BANNERS_008.txtContactName,
				Constant.TC_JOOMLA_BANNERS_BANNERS_008.txtContactEmail, Constant.TC_JOOMLA_BANNERS_BANNERS_008.txtTitle,
				Constant.TC_JOOMLA_BANNERS_BANNERS_008.txtName, Constant.TC_JOOMLA_BANNERS_BANNERS_008.cbbCategory}, };
	}
